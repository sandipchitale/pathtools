...
/**
 * An abstract field editor that manages a table of input values. 
 * The editor displays a table containing the rows of values, buttons for
 * adding and removing rows, duplicating rows, and Up and Down buttons to adjust
 * the order of elements in the table. The table also allows in-place
 * editing of values.
 * 
 * <p>
...
public abstract class TableFieldEditor extends FieldEditor {
    ...
    /**
     * The table widget; <code>null</code> if none
    ...
    /**
     * Splits the given string into a array of array of items.
